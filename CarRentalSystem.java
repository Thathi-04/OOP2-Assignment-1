...
// A program to show a car rental system
...
public class CarRentalSystem {
    public static void main(String[] args) {
        ...
        Car car1 = new Car("C001", "Mercedes");
        Car car2 = new Car("C002", "Mitsubishi");
        Car car3 = new Car("C003", "Ford");
        agency.addCar(car1);
        agency.addCar(car2);
        agency.addCar(car3);

        Customer cust1 = new Customer("CU001", "Shallon");
        Customer cust2 = new Customer("CU002", "Thathi");
